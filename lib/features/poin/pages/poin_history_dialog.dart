...
class PoinHistoryDialog extends StatelessWidget {
  ...
  final List<PoinHistoryModel> history;
  ...
  Widget _buildHistoryItem(PoinHistoryModel item, String type) {
    final color = type == 'masuk' ? Colors.green : Colors.orange;
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  item.date.isNotEmpty ? item.date : 'Tanpa tanggal',
                  style: const TextStyle(
                    color: Colors.grey,
                    fontSize: 11,
                  ),
